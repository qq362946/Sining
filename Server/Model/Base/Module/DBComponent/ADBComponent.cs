...
namespace Sining.Module
{
    public abstract class ADBComponent : Component
    {
        ...
        public abstract STask<long> Count<T>(string collection = null) where T : Component;

        public abstract STask<long> Count<T>(Expression<Func<T, bool>> filter, string collection = null)
            where T : Component;

        public abstract STask<bool> Exist<T>(string collection = null) where T : Component;
