...
{
    [ComponentSystem]
    public class WebSocketComponentAwakeSystem : AwakeSystem<WebSocketComponent, IEnumerable<string>>
    {
        protected override void Awake(WebSocketComponent self, IEnumerable<string> urls)
        {
            self.Awake(urls);
        }
    }
